...
const navItems = [
  { label: pt.nav.dashboard, href: "/dashboard" },
  { label: pt.nav.overview, href: "/overview" },
  { label: pt.nav.inbox, href: "/inbox" },
  { label: pt.nav.campaigns, href: "/campaigns" },
  { label: pt.nav.logs, href: "/logs" },
  { label: pt.nav.settings, href: "/settings" },
  { label: pt.nav.diagnostics, href: "/diagnostics" },
];
