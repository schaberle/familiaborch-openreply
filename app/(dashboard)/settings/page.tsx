        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-3 py-3 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted mt-0.5">
                Comentários e DMs automáticos dependem desta ligação.
              </p>
            </div>
            <span
          ...
          <div className="flex items-center justify-between gap-3 py-3 border-b border-border">
            <div>
              ...
              <p className="text-xs text-muted mt-0.5">
                {accounts.length === 1
                  ? "1 perfil do Instagram ligado"
                  : `${accounts.length} perfis do Instagram ligados`}
              </p>
            </div>
            <span className="text-sm text-muted">
              {accounts.length > 0 ? `${accounts.length} ligada(s)` : "Nenhuma"}
            </span>
          </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted">
                    ...
                    {account.tokenExpiresAt
                      ...
                      : "sem data"}{" "}
                    · {account.webhookSubscribed ? "Webhook ok" : "Webhook pendente"}
                  </p>
                </div>
                <button
      ...
      <section className="panel rounded p-4 sm:p-6">
        ...
        <div className="flex items-center justify-between gap-3 py-3">
          <div>
            ...
            <p className="text-xs text-muted mt-0.5">
              Sem limite de plano nesta instalação.
            </p>
          </div>
